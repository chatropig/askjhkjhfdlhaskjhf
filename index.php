...
<head>
    ...
    <link rel="stylesheet" href="css/main.css?v=1770403069">
...
<script>
    ...
    <div class="slider-container">
        <div class="slider-wrapper" id="homeSlider">
            <div class="slide"><img src="images/img3.jpeg" onerror="this.src='https://placehold.co/600x300/111/gold?text=WELCOME+BONUS'"></div>
            <div class="slide"><img src="images/img2.jpeg" onerror="this.src='https://placehold.co/600x300/222/red?text=PLAY+AVIATOR'"></div>
            <div class="slide"><img src="images/img5.jpg" onerror="this.src='https://placehold.co/600x300/333/blue?text=INSTANT+WITHDRAW'"></div>
            <div class="slide"><img src="images/img4.jpeg" onerror="this.src='https://placehold.co/600x300/000/green?text=VIP+REWARDS'"></div>
            <div class="slide"><img src="images/img1.jpeg" onerror="this.src='https://placehold.co/600x300/111/white?text=REFER+EARN'"></div>
            <div class="slide"><img src="images/img6.jpg" onerror="this.src='https://placehold.co/600x300/222/orange?text=JACKPOT'"></div>
        </div>
    </div>

    <div class="section-title">ORIGINAL GAMES</div>
    
    <div class="games-grid">
        <div class="game-card featured" onclick="window.location.href='chicken.php'">
            <img src="images/chicken.png" class="game-img" onerror="this.src='https://placehold.co/600x500/1a1a1a/gold?text=CHICKEN+ROAD'">
            <div class="game-info"><h4 class="game-title">Chicken Road</h4></div>
        </div>
        <div class="game-card" onclick="window.location.href='aviator.php'">
            <img src="images/aviator.png" class="game-img" onerror="this.src='https://placehold.co/300x200/1a1a1a/red?text=AVIATOR'">
            <div class="game-info"><h4 class="game-title">Aviator</h4></div>
        </div>
        <div class="game-card" onclick="window.location.href='tower-rush.php'">
            <img src="images/tower/towerx.png" class="game-img" onerror="this.src='https://placehold.co/300x200/1a1a1a/blue?text=MINES'">
            <div class="game-info"><h4 class="game-title">Tower Rush</h4></div>
        </div>
    </div>

    <div class="legal-section">
        <div class="legal-title">Risk Disclosure</div>
        <p class="legal-text">
            Participation in gaming involves financial risk. By using this platform, you acknowledge that you are 18+ years old. 
            <strong>JetPlay</strong> is not responsible for any financial losses. Play responsibly.
        </p>

        <div class="legal-title">No Refund Policy</div>
        <p class="legal-text">
            All deposits are final. Once funds are used in gameplay, they cannot be refunded or cancelled. 
            Withdrawals are processed only to the registered bank account of the user.
        </p>
        ...
        <div class="legal-footer">
            &copy; 2024 JetPlay. All rights reserved.<br>
            Licensed by Galactic Gaming Authority.
        </div>
    </div>

    <div class="bottom-nav">
        <a href="index.php" class="nav-item-link active"><i class="fas fa-home"></i> Home</a>
        <a href="refer.php" class="nav-item-link"><i class="fas fa-share-alt"></i> Refer</a>
        <a href="wallet.php" class="nav-item-link"><i class="fas fa-wallet"></i> Wallet</a>
        <a href="profile.php" class="nav-item-link"><i class="fas fa-user"></i> Profile</a>
    </div>
