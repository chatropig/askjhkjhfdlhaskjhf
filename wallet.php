...
<head>
    ...
    <link rel="stylesheet" href="css/main.css?v=1770403362">
</head>
...
<script>
    ...
    <div class="wallet-top-section">
        <div class="real-wallet-card">
            <div class="rwc-left">
                <span class="rwc-label">Total Balance</span>
                <span class="rwc-balance">₹ 0.00</span>
            </div>
            <img src="https://cdn-icons-png.flaticon.com/128/855/855279.png" class="rwc-icon-img" alt="Wallet">
        </div>
    </div>

    <div class="action-img-grid">
        
        <a href="deposit.php" class="act-card">
            <img src="/images/deposit.png" class="act-img" alt="Deposit">
            <div>
                <div class="act-title">Add Money</div>
                <div class="act-desc">Deposit via UPI</div>
            </div>
        </a>

        <a href="withdraw.php" class="act-card">
            <img src="/images/with.png" class="act-img" alt="Withdraw">
            <div>
                <div class="act-title">Withdraw</div>
                <div class="act-desc">Instant Payout</div>
            </div>
        </a>
    ...
    <div class="trans-title">
        ...
        <a href="transactions.php" class="trans-link">View All</a>
    </div>

    <div class="real-trans-list">
        
                                                    <div class="rt-item">
                    <div class="rt-left">
                        <div class="rt-icon-box">
                            <img src="https://cdn-icons-png.flaticon.com/128/5501/5501360.png" class="rt-img">
                        </div>
                        <div class="rt-info">
                            <h4>Deposit</h4>
                            <p>05 Feb, 10:59 PM</p>
                    ...
                    <div class="rt-right">
                        <span class="rt-amount c-green">
                            + ₹500                        </span>
                        <span class="rt-status c-yellow">
                            pending                        </span>
                    </div>
                </div>
    ...
    <div class="bottom-nav">
        ...
        <a href="refer.php" class="nav-item-link">
            <i class="fas fa-share-alt"></i> Refer
        </a>
        <a href="wallet.php" class="nav-item-link active">
