...
<head>
    ...
    <link rel="stylesheet" href="css/main.css?v=1770403269">
...
<script>
    ...
    <div class="refer-hero">
        <img src="https://cdn-icons-png.flaticon.com/512/3135/3135715.png" alt="Gift">
        <h2>Invite & Earn</h2>
        <p>Get ₹10 for every friend who joins!</p>
    </div>

    <div class="code-container">
        <div class="code-box">
            <div class="code-label">Your Referral Code</div>
            <div class="my-code" id="refCode">2A98E424</div>
            <button class="copy-btn" onclick="copyCode()">
                <i class="far fa-copy"></i> TAP TO COPY
            </button>
        </div>
    </div>
    ...
    <div class="stats-grid">
        ...
        <div class="stat-card">
            <div class="stat-val" style="color:#2ecc71;">₹0</div>
            <div class="stat-lbl">Total Earned</div>
        </div>
    </div>

    <div class="share-btns">
        <a href="whatsapp://send?text=Join JetPlay and earn money! Use my code: 2A98E424 Link: https://casabet.games/register.php?ref=2A98E424" class="s-btn btn-wa">
            <i class="fab fa-whatsapp"></i> WhatsApp
        </a>
        <a href="https://t.me/share/url?url=https://casabet.games/register.php?ref=2A98E424&text=Use my code: 2A98E424" class="s-btn btn-tg">
            <i class="fab fa-telegram-plane"></i> Telegram
        </a>
    </div>

    <div class="ref-list-box">
        <div class="list-header-ref">Recent Referrals</div>
        
                    <div style="text-align:center; padding:20px; color:#8b949e; font-size:14px;">
                <i class="fas fa-user-plus" style="font-size:30px; margin-bottom:10px;"></i>
                <br>No referrals yet. Share your link!
            </div>
            </div>
    ...
    <div class="bottom-nav">
        ...
        <a href="refer.php" class="nav-item-link active">
            <i class="fas fa-share-alt"></i> Refer
        </a>
        <a href="wallet.php" class="nav-item-link">
