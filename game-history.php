...
<head>
    ...
    <link rel="stylesheet" href="css/main.css?v=1770403652">
</head>
...
<script>
    ...
    <div class="gh-stats-row">
        <div class="gh-stat-card">
            <div class="gh-label">Total Wagered</div>
            <div class="gh-value">₹0</div>
        </div>
        <div class="gh-stat-card">
            <div class="gh-label">Total Won</div>
            <div class="gh-value" style="color:#238636;">₹0</div>
        </div>
    </div>

    <div class="gh-list-header">Recent Activity</div>
    ...
    <div class="bottom-nav"> <a href="index.php" class="nav-item-link">
        ...
        <a href="profile.php" class="nav-item-link active"> <i class="fas fa-user"></i> Profile
        </a>
    </div>
