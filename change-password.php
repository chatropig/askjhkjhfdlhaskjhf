...
<head>
    ...
    <link rel="stylesheet" href="css/main.css?v=1770403707">
    <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    <link rel="stylesheet" href="css/toastr.min.css">
</head>
<body class="profile-page-bg" oncontextmenu="return false;">
...
<script>
    ...
    <div class="security-container">
        ...
        <div class="sec-card">
            ...
            <h2 class="sec-title">Update Password</h2>
            <p class="sec-desc">Ensure your account is using a long, random password to stay secure.</p>

            <form id="passForm" onsubmit="updatePass(event)">
                
                <div class="sec-input-group">
                    <label class="sec-label">Current Password</label>
                    <input type="password" name="old_pass" class="sec-input" placeholder="Enter old password" required>
                </div>

                <div class="sec-input-group">
                    <label class="sec-label">New Password</label>
                    <input type="password" name="new_pass" class="sec-input" placeholder="Set new password" required>
                </div>

                <div class="sec-input-group">
                    <label class="sec-label">Confirm New Password</label>
                    <input type="password" name="confirm_pass" class="sec-input" placeholder="Repeat new password" required>
                </div>
    ...
    <script>
        ...
        function updatePass(e) {
            ...
            btn.html('<i class="fas fa-spinner fa-spin"></i> UPDATING...').prop('disabled', true).css('opacity', 0.7);

            $.post('api/auth_changepass.php', $('#passForm').serialize(), function(res) {
                try {
